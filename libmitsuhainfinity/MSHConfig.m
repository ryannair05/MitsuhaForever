...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
  ...
  if (self) {
    ...
    CFNotificationCenterAddObserver(
        ...
        (CFStringRef)MSHPreferencesChanged, NULL, kNilOptions);
  }
  return self;
}
...
+ (NSDictionary *)parseConfigForApplication:(NSString *)name {
  ...
  NSMutableDictionary *colors =
      [[NSMutableDictionary alloc] initWithContentsOfFile:MSHColorsFile];
  ...
  for (NSString *key in [prefs allKeys]) {
    NSString *removedKey =
        [key stringByReplacingOccurrencesOfString:[NSString
                                                      stringWithFormat:@"MSH%@",
                                                                       name]
                                       withString:@""];
...
+ (MSHConfig *)loadConfigForApplication:(NSString *)name {
  return [[MSHConfig alloc]
      initWithDictionary:[MSHConfig parseConfigForApplication:name]];
}
